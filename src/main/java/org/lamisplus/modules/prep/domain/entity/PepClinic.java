...
public class PepClinic extends Audit implements Serializable {
    @Id
    ...
    @Type(type = "jsonb")
    @Basic(fetch = FetchType.LAZY)
    @Column(name = "pep_noted_side_effects", columnDefinition = "jsonb", nullable = true)
    ...
    @Type(type = "jsonb")
    @Basic(fetch = FetchType.LAZY)
    @Column(name = "followup_hiv_test_results", columnDefinition = "jsonb", nullable = true)
