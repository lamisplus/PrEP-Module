...
public interface PrepCompletionRepository extends JpaRepository<PrepCompletion, Long>, JpaSpecificationExecutor<PrepCompletion> {
    ...
    Optional<PrepCompletion> findFirstByInterruptionDateAndPersonUuidAndArchivedOrderByIdAsc(LocalDate interruptionDate, String personUuid, int archived);
    ...
    List<PrepCompletion> findAllByDateModifiedGreaterThanAndFacilityId(LocalDateTime dateLastSync, Long facilityId);
}
