...
const ADR = props => {
  ...
  const validate = () => {
    temp.ondateInfection = props.infection.ondateInfection
      ? ''
      : 'This field is required';
    temp.illnessInfection = props.infection.illnessInfection
      ? ''
      : 'This field is required';
...
function InfectionList({ relative, index, removeInfection }) {
  return (
    <tr>
