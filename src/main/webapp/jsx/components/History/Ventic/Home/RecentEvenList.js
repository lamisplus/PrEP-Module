      ...
      <div className="card event-bx">
        <div className="card-header border-0 mb-0">
          ...
          <Dropdown className="dropdown custom-dropdown mb-0 tbl-orders-style">
            <Dropdown.Toggle
              as="div"
              className="btn sharp tp-btn i-false c-pointer"
            >
              <svg
                width="24"
                height="24"
        ...
        <PerfectScrollbar className="dz-scroll">
          <div
            className="card-body  loadmore-content pt-0"
            id="EventListContent"
          >
            {data.map((item, index) => (
              <div
                className="media event-list pb-3 border-bottom mb-3"
                key={index}
              >
                <div className="image">
                ...
                <div className="media-body">
                  <h4 className="fs-18 mb-sm-0 mb-2">
                    <Link to={'/event'} className="text-black">
                      {' '}
                      Envato International Online Meetup 2020
                    </Link>
                  </h4>
                  <span className="fs-14 d-block mb-sm-3 mb-2 text-secondary">
                    Medan, Indonesia
                  </span>
                  <p className="fs-12">
        ...
        <div className="card-footer pt-0 border-0">
          <Link
            to={'#'}
            className="btn btn-secondary btn-lg btn-block text-white dz-load-more"
            onClick={() => onClick()}
          >
            Load More {refresh && <i className="fa fa-refresh"></i>}
          </Link>
        </div>
      </div>
    </>
